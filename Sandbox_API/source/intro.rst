...
* **copy** (for ``deepcopy``, which is useful when copying objects [but largely being phased out, due to its inefficiency], https://docs.python.org/3.8/library/copy.html#module-copy)
* **tqdm** (for showing progress bars, https://tqdm.github.io/)
