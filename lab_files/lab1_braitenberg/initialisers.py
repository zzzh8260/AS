...
'''
    In most, or possibly all, labs involving sensorimotor behaviour, we will use a "initialisers.py" file
    for any code purely related to setting up our agents' initial states. We separate this code from the
    main lab file so that we can keep that file as small and clear as possible.
'''


'''
    An init_conditions method for setting the initial conditions of the robot's pose (position and orientation).
