...
'''
def extended_braitenberg(dt, inputs, params, state=[]) -> List[float]:
    ...
    # inputs[6] is the left floor sensor
    left_speed_command += 0 * inputs[6] 
    right_speed_command += 0 * inputs[6]
    # inputs[7] is the right floor sensor
    left_speed_command += 0 * inputs[7]
    right_speed_command += 0 * inputs[7]
    # inputs[8] is the front floor sensor
    left_speed_command += 0 * inputs[8]
    right_speed_command += 0 * inputs[8]
